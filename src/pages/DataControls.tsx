    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="container max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Download all your avatar data, photos, and measurements in a portable format.
                </p>
                <Button 
                  variant="outline" 
          ...
          <Card className="p-6 border-destructive/20 bg-card/50 backdrop-blur-sm shadow-elegant">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Permanently delete your avatar, photos, and all associated data. 
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        This will permanently delete your avatar, all photos, measurements, 
          ...
          <Card className="p-6 border-border/50 bg-card/50 backdrop-blur-sm shadow-elegant">
            <h3 className="font-semibold mb-3">Data Privacy Summary</h3>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>✓ All data is encrypted in transit and at rest</li>
              <li>✓ We never share your data with third parties</li>
              <li>✓ You can delete your data at any time</li>
              <li>✓ Biometric data is used only for avatar generation</li>
            </ul>
            <Button
              variant="link"
