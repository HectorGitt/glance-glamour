          ...
          <div className="space-y-6 text-foreground">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                We collect face photographs and body measurements solely for the purpose of creating 
                your personalized 3D avatar and providing virtual try-on services. Your data is 
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Your biometric data is used exclusively to generate and maintain your avatar. 
                We do not share, sell, or use your data for any other purpose without your 
                explicit consent.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                All data is encrypted both in transit and at rest. We employ industry-standard 
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                You can export all your data or permanently delete your account and all 
                associated information through the Data Controls section.
              </p>
            </section>
